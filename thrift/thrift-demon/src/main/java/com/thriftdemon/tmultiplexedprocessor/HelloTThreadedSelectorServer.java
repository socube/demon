package com.thriftdemon.tmultiplexedprocessor;
...
import com.thriftdemon.service.UserServiceImpl;
...
/**
 * @Description 多线程Half-sync/Half-async的服务模型，需要指定为： TFramedTransport 数据传输的方式
 * 服务端提供对多接口服务支持
 * @Author xuedong.wang
 * @Date 17/6/16.
 */
